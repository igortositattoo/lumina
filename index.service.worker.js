...
/** @type {string} */
const CACHE_VERSION = '1789943799|15038491';
/** @type {string} */
const CACHE_PREFIX = 'Lúmina • Pequeno-sw-cache-';
...
/** @type {string[]} */
const CACHEABLE_FILES = ["index.wasm","index.pck.part0","index.pck.part1","index.pck.part2","index.pck.part3","index.pck.part4"];
